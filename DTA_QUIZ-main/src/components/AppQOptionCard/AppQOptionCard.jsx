        ...
        <div className="d-flex">
          ...
          <div className="mx-3">
            <div className="d-flex justify-content-between mb-2">
              <AppTitle3 text={title} otherClassNames="mb-2" />
              {icon && (
            ...
            {description && (
              <AppText1
                text={description}
                otherClassNames="mb-0 font-family-regular font-14"
              />
            )}
          </div>
        </div>
        ...
        {info ? (
          <div className="options_info_icon">
            <AppButton
              ...
              type="button"
              icon={<MdOutlineInfo style={{ width: "22px", height: "22px" }} />}
            />
            <AppInformationModal
              title={infoTitle}
              description={info}
